...
def admin_panel_keyboard(btn: dict[str, str]) -> InlineKeyboardMarkup:
    ...
    builder.button(text=btn["admin_btn_users"], callback_data="admin:users")
    builder.button(text=btn["admin_btn_files"], callback_data="admin:files")
    builder.button(text=btn["admin_btn_forced_join"], callback_data="adm_fj:menu")
    ...
    builder.button(text=btn["admin_btn_support"], callback_data="admin:support")
    builder.button(text=btn["admin_btn_broadcast"], callback_data="admin:broadcast")
    builder.button(text=btn["admin_btn_fwd_broadcast"], callback_data="admin:fwd_broadcast")
    builder.button(text=btn["admin_btn_reports"], callback_data="admin:reports")
